...
namespace mfx
{
    ...
    // 0.9.1 groups straight, triplet and dotted variants together in the UI.
    enum class SyncDiv
    {
        d4Bar, d2Bar, d1Bar,
        d1_2, d1_2T, d1_2D,
    ...
    inline double syncDivToBeats (SyncDiv division) noexcept
    {
        switch (division)
        {
            ...
            case SyncDiv::d1_8T:  return 1.0 / 3.0;
            case SyncDiv::d1_8D:  return 0.75;
            case SyncDiv::d1_16:  return 0.25;
            case SyncDiv::d1_16T: return 1.0 / 6.0;
    ...
    inline const char* syncDivLabel (SyncDiv division) noexcept
    {
        switch (division)
        {
            ...
            case SyncDiv::d1_2T:  return "1/2T";
            case SyncDiv::d1_2D:  return "1/2D";
            case SyncDiv::d1_4:   return "1/4";
            case SyncDiv::d1_4T:  return "1/4T";
            case SyncDiv::d1_4D:  return "1/4D";
            case SyncDiv::d1_8:   return "1/8";
            case SyncDiv::d1_8T:  return "1/8T";
            case SyncDiv::d1_8D:  return "1/8D";
            case SyncDiv::d1_16:  return "1/16";
            case SyncDiv::d1_16T: return "1/16T";
            case SyncDiv::d1_16D: return "1/16D";
            case SyncDiv::d1_32:  return "1/32";
            case SyncDiv::d1_32T: return "1/32T";
            case SyncDiv::d1_32D: return "1/32D";
        }

        return "1/4";
    }

    inline int syncDivGroupSize (SyncDiv division) noexcept
    {
        switch (division)
        {
            case SyncDiv::d1_2T:
